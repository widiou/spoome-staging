...
/**
 * Runner di migrazioni minimale (niente CLI/Composer sul server). Traccia lo stato in `migrations`.
 * Ogni file in database/migrations/ ritorna un oggetto con up(PDO) e down(PDO), applicati in ordine di nome.
 * NB: in MySQL i DDL fanno commit implicito → scrivere migrazioni idempotenti/difensive.
 */
